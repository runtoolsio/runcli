...
def _init_job_parser(parent, subparser):
    ...
    id_group.add_argument('-n', '--max-reruns', type=int, default=9, metavar='N',
                          help='Max reruns with the same run ID. On duplicate the run ID is suffixed with -2, -3, etc. '
                               'Set to 0 to fail immediately on duplicate. Default: 9.')
